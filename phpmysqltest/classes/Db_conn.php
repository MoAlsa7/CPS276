...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'maalsaman';//this will be your WCC username
      $dbUsr = 'maalsaman';//this will be your WCC username
      $dbPass = 'v8sKh7WKjxJG';//this will be the password found in the video.
